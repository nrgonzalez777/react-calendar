...
export interface AppointmentPeriodViewInputProps {
...
export interface AppointmentPeriodViewOutputProps {
  onAppointmentSelected: (appointmentId: string) => void;
}

export interface AppointmentPeriodViewProps
  extends AppointmentPeriodViewInputProps, AppointmentPeriodViewOutputProps {}
